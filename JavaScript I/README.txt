Это комментарий к тому "JavaScript I".

О функциях: строго говоря, язык не требует, чтобы весь исполняемый код был строго в функциях; просто, это устоявшийся практицизм.
