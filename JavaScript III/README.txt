Это комментарий к тому "JavaScript III".

В этом томе рассмотрен Client- side JavaScript. Глубина изложения - не запредельная, так как данная среда встраивания интерпретатора (вообще и в принципе) чрезвычайно быстро обновляется, и доподробное ее описание просто бессмысленно. Сама идея описать эту среду проистекла из желания описать хотя бы одну сакую среду (и браузер был выран как среда, которую традиционно принято описывать).
